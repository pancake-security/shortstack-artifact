...
python3 $SHORTSTACK_ROOT/gen_hosts_file.py /local/deploy/shortstack.hosts /local/deploy/hosts.csv $nl1 1 16 $nl2 1 16 $nl3 1 16 $nredis 1 1 0 $rep $rep
...
sleep 2; 
$sbin/run_l3.sh /local/deploy/hosts.csv -s 24 -c 1 -y 30 -m; 
sleep 4; 
